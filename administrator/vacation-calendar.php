...
<div class="content-wrapper">
	...
	<div class="container-xxl flex-grow-1 container-p-y">
		<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Gestion des vacances /</span>Calendrier des vacances</h4>
		<?php
		$daysInFrench = [
    'Mon' => 'Lun',
    'Tue' => 'Mar',
    ...
    'Sun' => 'Dim'
		...
		<div class="row">
			...
			<div class="card  col-md-4 ">
				...
				<tbody>
					<tr>
						<td style="background:#525dff; border-radius:5%;"><h4 style="    margin: 5px;color:white;">Mon</h4></td>
						<td>Date du jour</td>
					</tr>
					<tr>
						<td style="background: #ddd;"><h4 style="margin: 5px;color:black;">10</h4></td>
						<td >Week-end</td>
					</tr>
					<tr>
						<td style="background: #272658;"><h4 style="color: white;   margin: 5px;">1</h4></td>
						<td>Vacances approuvées</td>
					</tr>
					<tr>
						<td><i class="bx bxs-calendar-x" style="font-size: 40px;color:#401d95;"></i></td>
						<td>Jours fériés</td>
					</tr>
		...
		<div class="row">
			<form method="post" class="mb-3">
				<div class="btn-group" role="group" aria-label="Basic example"style="
					margin-right: 5px;">
					<button type="submit" name="decrement" class="btn btn-outline-secondary"><i class='bx bx-left-arrow-alt'></i></button>
					<button type="submit" name="increment" class="btn btn-outline-secondary"><i class='bx bx-right-arrow-alt' ></i></button>
					...
					$getleavinfo = mysqli_query($db, "SELECT * FROM `leave_request` WHERE `emp_id`='$caneid' AND `lr_status`='Approved'");
								...
								<tr>
									...
									if (mysqli_num_rows($getleavedates2)>0) {
										...
										echo '<td style="color:#401d95;"><i class="bx bxs-calendar-x"style="font-size: 40px;"></i></td>';
								...
								</tbody><!-- <i class="bx bxs-calendar-x"style="font-size: 40px;"></i> -->
							</table>
						</div>
					</div>
				</div>
